...
class ConvolutionBlock(chainer.Chain):
    def __init__(self, in_channels, out_channels):
        super(ConvolutionBlock, self).__init__(
            conv=chainer.links.Convolution2D(in_channels, out_channels, 7, 2, 3,
...
class ResidualBlock(chainer.Chain):
    def __init__(self, in_channels, out_channels):
        super(ResidualBlock, self).__init__(
            res_branch2a=chainer.links.Convolution2D(in_channels, out_channels, 3, pad=1,
                                                     initialW=chainer.initializers.HeNormal()),
            bn_branch2a=chainer.links.BatchNormalization(out_channels),
            res_branch2b=chainer.links.Convolution2D(out_channels, out_channels, 3, pad=1,
                                                     initialW=chainer.initializers.HeNormal()),
...
class ResidualBlockB(chainer.Chain):
    def __init__(self, in_channels, out_channels):
        super(ResidualBlockB, self).__init__(
            res_branch1=chainer.links.Convolution2D(in_channels, out_channels, 1, 2,
                                                    initialW=chainer.initializers.HeNormal()),
            bn_branch1=chainer.links.BatchNormalization(out_channels),
            res_branch2a=chainer.links.Convolution2D(in_channels, out_channels, 3, 2, 1,
                                                     initialW=chainer.initializers.HeNormal()),
            bn_branch2a=chainer.links.BatchNormalization(out_channels),
            res_branch2b=chainer.links.Convolution2D(out_channels, out_channels, 3, pad=1,
                                                     initialW=chainer.initializers.HeNormal()),
